...
nb_direct_and_transitive_deps_area <-
  ...
  scale_fill_viridis(discrete = TRUE, begin = 0.5, end = 0.8, option = "plasma", alpha = 0.5) +
...
```{r}
# projects with all their dependencies declared
results %>% select(Artifact, AllDeps, Declared) %>% count(Declared)
