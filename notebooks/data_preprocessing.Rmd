...
results <-
  results %>% mutate(
    UsedDeclared =  ifelse(Used == T & Declared == T & Type == "direct", T, F),
    UsedUndeclared =  ifelse(Used == T & Declared == F, T, F),
    BloatedDeclared =  ifelse(Used == F & Declared == T & Type == "direct", T, F),
    BloatedUndeclared =  ifelse(Used == F & Declared == F, T, F)
  )
